        ...
        <Route element={<MinimalProviders />}>
          <Route element={<BlankLayout />}>
            ...
            <Route
              ...
              element={<VideoInterviewResponseViewer candidateId={window.location.pathname} aIInterviewStatusId = {window.location.pathname} />}
            />
          </Route>
        </Route>
        ...
        <Route element={<FullProviders />}>
          <Route element={<DefaultLayout />}>
            <Route path={AppPath.Verify} element={<VerifyEffect />} />
             ...
             <Route path={`${AppPath.VideoInterviewReview}/:candidateId`} element={<VideoInterviewResponseViewer candidateId={window.location.pathname}  aIInterviewStatusId = {window.location.pathname} />} />
